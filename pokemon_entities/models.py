...
class Pokemon(models.Model):
    ...
    image = models.ImageField(upload_to='pokemons/', null=True, blank=True, verbose_name = 'Путь к картинке')
    previous_evolution = models.ForeignKey("self", related_name='next_evolution', on_delete=models.DO_NOTHING,
